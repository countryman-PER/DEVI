...
/*
	for every Qi do{
          ri = P.subtract(Qipos);
	  Ei = ri.multiply(k).multiply(Qi).dvi...(ri.mag()...
	  Enet = Enet.add(Ei)
	}
 ...
 *          which a line flows.
*/
export function getPoints(vect1, h, angle){
...
export function getArrow3(ec, Vect1, Elinemidstart, Elinemidend, adepth, awidth) {
